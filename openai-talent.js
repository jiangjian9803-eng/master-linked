(()=>{
  ...
  root.innerHTML=`<div class="oai-shell">
    ...
    <section class="oai-kpis"><div class="oai-kpi"><span>人才总数</span><strong id="oaiTotal">0</strong></div><div class="oai-kpi"><span>重点目标</span><strong id="oaiTargets">0</strong></div><div class="oai-kpi"><span>已申请 Connect</span><strong id="oaiRequested">0</strong></div><div class="oai-kpi"><span>已连接 / 有回复</span><strong id="oaiEngaged">0</strong></div><div class="oai-kpi"><span>19+ 匹配</span><strong id="oaiLevel19">0</strong></div></section>
    ...
    <label>优先级<select id="oaiPriority"><option>A</option><option selected>B</option><option>C</option></select></label><label>19+ 判断<select id="oaiLevel19Field"><option value="review">待判断</option><option value="yes">匹配</option><option value="no">不匹配</option></select></label>
    ...
    <menu><button id="oaiSave" type="button" class="oai-button">保存人才</button><button id="oaiCancel" type="button" class="oai-button secondary">取消</button></menu></div></form></dialog>`;
