(()=>{
  ...
  ['#oaiSearch','#oaiCompanyFilter','#oaiTeamFilter','#oaiStatusFilter','#oaiPriorityFilter','#oaiLevelFilter'].forEach(s=>$(s).addEventListener(s==='#oaiSearch'?'input':'change',()=>{if(s==='#oaiTeamFilter')state.selectedTeam=$(s).value;render();}));
